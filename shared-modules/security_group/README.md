...
| <a name="input_ingress_referenced_sg_ids"></a> [ingress\_referenced\_sg\_ids](#input\_ingress\_referenced\_sg\_ids) | A set of referenced SG ids for ingress | `set(string)` | `[]` | no |
