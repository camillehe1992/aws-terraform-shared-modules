...
Creates AWS EventBridge rules with targets for event-driven architectures.
...
| <a name="input_input_transformer_specs"></a> [input\_transformer\_specs](#input\_input\_transformer\_specs) | The input transformer specifications for the rule | <pre>object({<br/>    input_paths    = optional(map(string))<br/>    input_template = string<br/>  })</pre> | `null` | no |
