...
Creates AWS IAM roles with policies and trust relationships for various AWS services.
...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_managed_policy_arns"></a> [aws\_managed\_policy\_arns](#input\_aws\_managed\_policy\_arns) | A set of AWS managed policy ARNs to attach to the role | `set(string)` | <pre>[<br/>  "arn:aws:iam::aws:policy/AmazonEC2FullAccess"<br/>]</pre> | no |
