...
| [sns_topic](./shared-modules/sns_topic/README.md)                                 | Create SNS topic with subscription and delivery policy                                                    |
| [sqs_queue](./shared-modules/sqs_queue/README.md)                                 | Create SQS queue with optional DLQ configuration. Supports HTTPS-only traffic and least privilege access. |
